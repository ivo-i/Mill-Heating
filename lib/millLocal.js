...
class MillLocal extends millAPI {
	constructor(ipAddress) {
		...
		if (!ipAddress) {
			console.log("Ingen lokal Mill-ovn til stede. Avslutter MillLocal.");
			return;
		}
	...
	async initLocalApi() {
		if (!this.ipAddress) {
			console.log("Ingen lokal Mill-ovn til stede. Avslutter initLocalApi.");
			return;
		} else {
			console.log("Initierer lokal Mill-ovn.");
