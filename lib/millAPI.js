...
class MillAPI extends EventEmitter {
	...
	async setOilHeaterPowerMode() {
		throw new Error('setOilHeaterPowerMode() is not available for cloud devices');
	}
	async getOilHeaterPowerMode() {
		throw new Error('getOilHeaterPowerMode() is not available for cloud devices');
	}
