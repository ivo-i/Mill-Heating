...
class Mill {
  ...
  async login(username, password) {
    ...
    try {
      ...
      // If the server returns a non-2xx status, an error is thrown and we can catch it here
      // You can inspect the error object to see what went wrong and present the error message to the user
      // For example, if the error is a LogInError, you might want to tell the user their username/password is incorrect
